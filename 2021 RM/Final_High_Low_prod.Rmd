...
Keith_data = read_excel("Z:\\pgm output\\ACOV2-5176 (Final High Low Revenue Calculations)\\Keith\\ACO5176_CMSxpt_Prod.xlsx", sheet=1) 
...
POR = read_excel("Z:\\participant management\\prescreening\\2021 Prescreening\\Batch G4\\Participation Options Report\\Participation_Options_PY2021_Full_Assignment_20201123.xlsx", sheet=1)%>% 
...
Summary_tab = read_excel("Z:\\participant management\\prescreening\\2021 Prescreening\\Batch G4\\Participation Options Report\\Participation_Options_PY2021_Full_Assignment_20201123.xlsx", sheet=2)
...
```{r Identify  ACOs eligible for RM increase}
unique(Kevin_SAS$`Repayment Mechanism Amount Action Required`)

ACOs_need_increase = Kevin_SAS %>% filter(`Repayment Mechanism Amount Action Required` == "Contact your ACO coordinator, ACO met threshold for potential RM increase")
